...
const InfoAndAttributionsContent = (props: Props) => {
  return (
    <ContentContainer>
      <PreferencesTitle>Attributions</PreferencesTitle>
      <Row $justifyContent="flex-start" $gap="2rem" $alignItems="flex-start">
        <div
        ...
        <PreferencesDescription>
          <strong>ScreenVibe</strong> uses images and information provided by <strong>The Movie Database (TMDb)</strong>
          .
          <br /> <br />
          <strong>ScreenVibe</strong> uses the TMDb API but is not endorsed or certified by <strong>TMDb</strong>.
        </PreferencesDescription>
      </Row>
    </ContentContainer>
  );
...
export default InfoAndAttributionsContent;
