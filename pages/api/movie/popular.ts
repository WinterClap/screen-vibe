...
export type PopularMovieDetails = {
  page: number;
  results: {
...
export default async function handler(req: NextApiRequest, res: NextApiResponse<PopularMovieData>) {
