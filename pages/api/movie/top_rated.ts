...
export type TopRatedMovieDetails = {
  page: number;
  results: {
...
export default async function handler(req: NextApiRequest, res: NextApiResponse<TopRatedMovieData>) {
