...
export type NowPlayingMovieDetails = {
  page: number;
  results: {
...
export default async function handler(req: NextApiRequest, res: NextApiResponse<NowPlayingMovieData>) {
  ...
  console.log(
    `${tmbd_base_url}/movie/now_playing?` +
      new URLSearchParams({
        api_key,
        language,
        page,
