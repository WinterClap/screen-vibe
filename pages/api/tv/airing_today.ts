...
export type AiringTodayTvDetails = {
  page: number;
  results: {
...
export type AiringTodayTvData = AiringTodayTvDetails | { status_message: string; status_code: number };
export default async function handler(req: NextApiRequest, res: NextApiResponse<AiringTodayTvData>) {
