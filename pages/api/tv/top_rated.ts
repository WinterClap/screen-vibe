...
export type TopRatedTvData = TopRatedTvDetails | { status_message: string; status_code: number };
export default async function handler(req: NextApiRequest, res: NextApiResponse<TopRatedTvData>) {
